...
import { E as CreditCard, S as LoaderCircle, j as Check, x as Lock } from "./_libs/lucide-react.mjs";
import { d as saveShippingAddress } from "./_ssr/inquiry.service-BAeOUobU.mjs";
import { t as Route } from "./_paymentId-D86pf6N8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_paymentId-wj1sNjnS.js
...
function CommissionPaymentPage() {
	...
	async function submitShippingAddress() {
		...
		try {
			...
			setError("");
			await saveShippingAddress(payment.inquiry_id, {
			...
			console.error(err);
			setError(err instanceof Error ? err.message : "Could not save your shipping address.");
		} finally {
