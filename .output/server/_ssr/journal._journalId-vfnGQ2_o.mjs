...
//#region node_modules/.nitro/vite/services/ssr/assets/journal._journalId-vfnGQ2_o.js
var $$splitComponentImporter = () => import("./journal._journalId-F3sYKS_5.mjs");
...
var Route = createFileRoute("/journal/$journalId")({
	...
	head: ({ loaderData }) => {
		if (!loaderData) return { meta: [{ title: "Journal entry not found • PaintTheory" }, {
			name: "robots",
			content: "noindex"
		}] };
		const { journal } = loaderData;
		return { meta: [{ title: `${journal.title} • PaintTheory` }, {
			name: "description",
