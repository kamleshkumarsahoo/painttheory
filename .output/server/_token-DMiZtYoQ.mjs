...
import { d as saveShippingAddress, u as getInquiryByToken } from "./_ssr/inquiry.service-BAeOUobU.mjs";
import { t as Textarea } from "./_ssr/textarea-kko37XEX.mjs";
import { n as toast } from "./_libs/sonner.mjs";
import { t as Route } from "./_token-BlGd1-le.mjs";
import { t as motion } from "./_libs/motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_token-DMiZtYoQ.js
...
function CustomerOrderPage() {
	...
	async function loadInquiry() {
		try {
			...
			else if (data.address_submitted_at) setPaidStage("thanks");
	...
	async function handleSaveAddress() {
		try {
			...
			const updatedInquiry = await saveShippingAddress(inquiry.id, address);
